...
function Home() {
    ...
    const [dismissBanner, setDismissBanner] = useState(false)   // ← new
                                ...
                                <AnimatePresence>
                                    {openProfile && (
                                        ...
                                        >
                                            ...
                                            <button
                                                className='md:hidden w-full px-4 py-3 text-left text-sm border-b border-white/10 hover:bg-white/5 text-emerald-400'
                                                onClick={() => { window.open("https://koda-ai-client.onrender.com/", "_blank"); setOpenProfile(false) }}
                                            >
                                                ⚡ Try Alt Model
                                            </button>
